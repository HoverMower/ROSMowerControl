sap.ui.require([
  ...
  var sViewName = "rosmower.ROSMowerControl.view.MainView";
      ...
      assertions: {
          ...
          iShouldSeeTheTitle: function () {
            return this.waitFor({
              ...
              properties: {
                text: "Title of rosmower.ROSMowerControl"
              },
              success: function() {
                Opa5.assert.ok(true, "The page shows the correct title");
              },
              errorMessage: "App does not show the expected title rosmower.ROSMowerControl"
            });
        }
      }
